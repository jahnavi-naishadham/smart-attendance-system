...
class GenerateQRCodeView(View):
    def get(self, request, topic_id):
        ...
        return render(request, 'qr_code.html', {'qr_code': img_str, 'topic': topic, 'timestamp': timestamp,'qr_data': qr_data})
...
class SubmitAttendanceView(View):
    def get(self, request, topic_id):
        ...
        if last_submission and now() - last_submission.submission_time < timedelta(hours=1):
